...
var _lukewestby$elm_http_builder$HttpBuilder$defaultInternals = {cacheBuster: false, fileZeroStatusAllowed: false};
...
var _lukewestby$elm_http_builder$HttpBuilder$withFileZeroStatusAllowed = _lukewestby$elm_http_builder$HttpBuilder$mapInternals(
	function (internals) {
		return _elm_lang$core$Native_Utils.update(
			internals,
...
var _user$project$Launchpad$programWithFlags = _user$project$Native_Launchpad.programWithFlags;
var _user$project$Launchpad$program = function (app) {
	return _user$project$Launchpad$programWithFlags(
		_elm_lang$core$Native_Utils.update(
			app,
			{
				init: _elm_lang$core$Basics$always(app.init)
			}));
};
var _user$project$Launchpad$beginnerProgram = function (app) {
	return _user$project$Launchpad$program(
		{
			init: {ctor: '_Tuple2', _0: app.model, _1: _elm_lang$core$Platform_Cmd$none},
			update: F2(
				function (msg, model) {
					return {
						ctor: '_Tuple2',
						_0: A2(app.update, msg, model),
...
var _user$project$Launchpad$map = _user$project$Native_Launchpad.map;
var _user$project$Launchpad$group = _user$project$Native_Launchpad.group;
var _user$project$Launchpad$button = _user$project$Native_Launchpad.button;
var _user$project$Launchpad$Color = function (a) {
	return {ctor: 'Color', _0: a};
};
var _user$project$Launchpad$lowRed = _user$project$Launchpad$Color('low-red');
var _user$project$Launchpad$red = _user$project$Launchpad$Color('red');
var _user$project$Launchpad$lowAmber = _user$project$Launchpad$Color('low-amber');
var _user$project$Launchpad$amber = _user$project$Launchpad$Color('amber');
var _user$project$Launchpad$yellow = _user$project$Launchpad$Color('yellow');
var _user$project$Launchpad$lowGreen = _user$project$Launchpad$Color('low-green');
var _user$project$Launchpad$green = _user$project$Launchpad$Color('green');
var _user$project$Launchpad$Node = {ctor: 'Node'};

var _user$project$SlackButton$decodeSlackSuccess = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['ok']),
	_elm_lang$core$Json_Decode$bool);
var _user$project$SlackButton$Model = F4(
	function (a, b, c, d) {
		return {loadState: a, lastToggle: b, flashOn: c, token: d};
	});
var _user$project$SlackButton$Failure = {ctor: 'Failure'};
var _user$project$SlackButton$Success = {ctor: 'Success'};
var _user$project$SlackButton$Loading = {ctor: 'Loading'};
var _user$project$SlackButton$Initial = {ctor: 'Initial'};
var _user$project$SlackButton$model = A3(_user$project$SlackButton$Model, _user$project$SlackButton$Initial, 0, true);
var _user$project$SlackButton$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$SlackButton$initialize = function () {
	var never = function (n) {
		never:
		while (true) {
			var _v0 = n;
			n = _v0;
	...
	return A3(_elm_lang$core$Task$perform, never, _user$project$SlackButton$Tick, _elm_lang$core$Time$now);
}();
var _user$project$SlackButton$subscriptions = function (model) {
	var _p0 = model.loadState;
	if (_p0.ctor === 'Loading') {
		return A2(_elm_lang$core$Time$every, 50, _user$project$SlackButton$Tick);
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _user$project$SlackButton$PostFailure = {ctor: 'PostFailure'};
var _user$project$SlackButton$PostSuccess = {ctor: 'PostSuccess'};
var _user$project$SlackButton$handleSlackResponse = function (ok) {
	return ok ? _user$project$SlackButton$PostSuccess : _user$project$SlackButton$PostFailure;
};
var _user$project$SlackButton$postToSlack = F3(
	function (row, column, token) {
		var slackUrl = A2(
			_lukewestby$elm_http_builder$HttpBuilder$url,
			'https://slack.com/api/chat.postMessage',
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'token', _1: token},
					{ctor: '_Tuple2', _0: 'channel', _1: '@slackbot'},
					{
					ctor: '_Tuple2',
					_0: 'text',
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						'Hello from the button at ',
						_elm_lang$core$Basics$toString(
							{ctor: '_Tuple2', _0: row, _1: column}))
				},
					{ctor: '_Tuple2', _0: 'username', _1: '@luke'},
					{ctor: '_Tuple2', _0: 'as_user', _1: 'true'}
				]));
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$always(_user$project$SlackButton$PostFailure),
			_user$project$SlackButton$handleSlackResponse,
			A2(
				_elm_lang$core$Task$map,
				function (_) {
					return _.data;
				...
				A3(
					...
					_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_user$project$SlackButton$decodeSlackSuccess),
					_lukewestby$elm_http_builder$HttpBuilder$stringReader,
					_lukewestby$elm_http_builder$HttpBuilder$get(slackUrl))));
	});
var _user$project$SlackButton$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'PostToSlack':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loadState: _user$project$SlackButton$Loading}),
					_1: A3(_user$project$SlackButton$postToSlack, _p1._0, _p1._1, model.token)
				};
			case 'PostSuccess':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loadState: _user$project$SlackButton$Success}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PostFailure':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loadState: _user$project$SlackButton$Failure}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p2 = _p1._0;
				return _elm_lang$core$Native_Utils.eq(model.lastToggle, 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{lastToggle: _p2}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : ((_elm_lang$core$Native_Utils.cmp(_p2 - model.lastToggle, 0.25 * _elm_lang$core$Time$second) > -1) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							lastToggle: _p2,
							flashOn: _elm_lang$core$Basics$not(model.flashOn)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : A2(
...
var _user$project$SlackButton$PostToSlack = F2(
	function (a, b) {
		return {ctor: 'PostToSlack', _0: a, _1: b};
	});
var _user$project$SlackButton$view = F3(
	function (row, column, model) {
		var color = function () {
			var _p3 = model.loadState;
			switch (_p3.ctor) {
				case 'Success':
					return _user$project$Launchpad$green;
				case 'Failure':
					return _user$project$Launchpad$red;
				case 'Initial':
					return _user$project$Launchpad$amber;
				default:
					return model.flashOn ? _user$project$Launchpad$amber : _user$project$Launchpad$lowAmber;
			}
		}();
		var onButtonOff = function () {
			var _p4 = model.loadState;
			if (_p4.ctor === 'Loading') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				return _elm_lang$core$Maybe$Just(
					A2(_user$project$SlackButton$PostToSlack, row, column));
			}
		}();
		return _user$project$Launchpad$button(
			{row: row, column: column, on: true, onButtonOff: onButtonOff, onButtonOn: _elm_lang$core$Maybe$Nothing, color: color});
	});

var _user$project$Main$model = function (token) {
	return {
		slackButtons: _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (value) {
					return {
						ctor: '_Tuple2',
						_0: value,
						_1: _user$project$SlackButton$model(token)
					};
				},
...
var _user$project$Main$Model = function (a) {
	return {slackButtons: a};
};
var _user$project$Main$Flags = function (a) {
	return {slackToken: a};
};
var _user$project$Main$SlackButtonMsg = F2(
	function (a, b) {
		return {ctor: 'SlackButtonMsg', _0: a, _1: b};
	});
var _user$project$Main$initialize = function (model) {
		...
		A2(
			...
			function (location) {
				return A2(
					...
					_user$project$Main$SlackButtonMsg(location),
					_user$project$SlackButton$initialize);
			},
			_elm_lang$core$Dict$keys(model.slackButtons)));
};
var _user$project$Main$init = function (flags) {
	var initModel = _user$project$Main$model(flags.slackToken);
	return {
		ctor: '_Tuple2',
		_0: initModel,
		_1: _user$project$Main$initialize(initModel)
	};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p3 = _p0._0;
		var _p1 = A2(_elm_lang$core$Dict$get, _p3, model.slackButtons);
		if (_p1.ctor === 'Just') {
			var _p2 = A2(_user$project$SlackButton$update, _p0._1, _p1._0);
			var nextSubModel = _p2._0;
			var subCmd = _p2._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						slackButtons: A3(_elm_lang$core$Dict$insert, _p3, nextSubModel, model.slackButtons)
					}),
				_1: A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Main$SlackButtonMsg(_p3),
					subCmd)
			};
		} else {
			return A2(
...
var _user$project$Main$viewButton = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._0;
	return A2(
		_user$project$Launchpad$map,
		_user$project$Main$SlackButtonMsg(_p6),
		A3(
			_user$project$SlackButton$view,
			_elm_lang$core$Basics$fst(_p6),
			_elm_lang$core$Basics$snd(_p6),
			_p5._1));
};
var _user$project$Main$view = function (model) {
	return _user$project$Launchpad$group(
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$viewButton,
			_elm_lang$core$Dict$toList(model.slackButtons)));
};
		...
		A2(
			...
			function (_p7) {
				...
				return A2(
					...
					_user$project$Main$SlackButtonMsg(_p8._0),
					_user$project$SlackButton$subscriptions(_p8._1));
			},
			_elm_lang$core$Dict$toList(model.slackButtons)));
};
var _user$project$Main$main = {
	main: _user$project$Launchpad$programWithFlags(
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'slackToken', _elm_lang$core$Json_Decode$string),
		function (slackToken) {
